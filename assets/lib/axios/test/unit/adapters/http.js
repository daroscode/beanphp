...
describe('supports http with nodejs', function () {
  ...
  it('should allow passing JSON', function (done) {
    ...
    server = http.createServer(function (req, res) {
      ...
      axios.get('https://localhost:4444/').then(function (res) {
  ...
  it('should redirect', function (done) {
    ...
    server = http.createServer(function (req, res) {
      ...
      axios.get('https://localhost:4444/one').then(function (res) {
  ...
  it('should preserve the HTTP verb on redirect', function (done) {
    server = http.createServer(function (req, res) {
      ...
      axios.head('https://localhost:4444/one').then(function (res) {
  ...
  it('should support gunzip error handling', function (done) {
    server = http.createServer(function (req, res) {
      ...
      axios.get('https://localhost:4444/').catch(function (error) {
        done();
      });
    });
  });
  ...
  it('should support basic auth', function (done) {
    server = http.createServer(function (req, res) {
      ...
      axios.get('https://' + user + '@localhost:4444/', { headers: headers }).then(function (res) {
  ...
  it('should support basic auth with a header', function (done) {
    server = http.createServer(function (req, res) {
      ...
      var headers = { Authorization: 'Bearer 1234' };
      axios.get('https://localhost:4444/', { auth: auth, headers: headers }).then(function (res) {
  ...
  it('should support streams', function (done) {
    server = http.createServer(function (req, res) {
      ...
      axios.post('https://localhost:4444/',
  ...
  it('should not pass through disabled proxy', function (done) {
    ...
    process.env.http_proxy = 'https://does-not-exists.example.com:4242/';
  ...
  it('should support proxy auth from env', function (done) {
    server = http.createServer(function (req, res) {
      ...
      proxy = http.createServer(function (request, response) {
        ...
        process.env.http_proxy = 'https://user:pass@localhost:4000/';
